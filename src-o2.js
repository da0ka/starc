...
***************************************************/
// compress
function o2e(A,pb,bs,up,done,rate){
	...
	var z=A.length,a=0,b,c=z<3?z:2,e,i,n,o=0,p=A[0]<<8|A[1],B=(pb&=7)|!!up<<4|c<<5,N=0,L=0,R=-1>>>0,fx=1<<(pb+=8),O=[],C=[],D=[],F=[],P=[],S=new Uint8Array(256);
...
function o2d(A,done,rate){
	...
	var a=1,b,c=A[0],d,e,o=5,p=0,x,pb=8+(c&7),up=c>>4&1,L,R=-1>>>0,O=[],C=[],D=[],F=[],P=[],S=new Uint8Array(256);
	done=done||function(O){return O};rate=rate||function(){};
	O.b=gbits;O.c=cbt;
	for(;--o;)L=(L<<8|A[a++])>>>0;
